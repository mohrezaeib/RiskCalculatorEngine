...
{
    public partial class RootRiskCondition : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MappingTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StartRange = table.Column<double>(type: "float", nullable: true),
                    EndRange = table.Column<double>(type: "float", nullable: true),
                    ConstantString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DivideFilter = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DivideValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Score = table.Column<double>(type: "float", nullable: false),
                    EffectRatio = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiskConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RiskConditions_RiskConditions_ParentId",
                        column: x => x.ParentId,
                        principalTable: "RiskConditions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RiskConditions_ParentId",
